...
export const EditTodo: React.FC<Props> = ({ todo, id }) => {
    const [todos, setTodos] = useState<string>(todo);

    const updateTodo = async (e: React.FormEvent<HTMLButtonElement>) => {
        e.preventDefault();
        try {
    ...
    return (
        <>
            <button type="button" className="btn btn-success me-3" data-bs-toggle="modal" data-bs-target={`#id${id}`}>
                Edit Todo
            </button>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary" onClick={(e) => updateTodo(e)}>
                                Update Todo
                            </button>
                        </div>
                    </div>
